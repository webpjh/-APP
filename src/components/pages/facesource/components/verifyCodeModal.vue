    ...
    <div class="modal-layer-popup">
      <div class="modal-layer-success" v-if="!videoFail">
        ...
        <div class="modal-wrapper" :class="{'modal-point': btnPoint}">
          ...
          >{{timeHaveToStay | confirmBtnText}}</x-button>
          <input
            type="file"
            class="camera-input"
      ...
      <div class="modal-layer-fail" v-if="videoFail">
        <div class="modal-layer-fail-icon" :style="iconImg"></div>
        <div class="modal-layer-fail-title">{{videoFailText.title}}</div>
        <div class="modal-layer-fail-detail">{{videoFailText.detail}}</div>
        <x-button type="primary" class="modal-layer-fail-restart" @click="videoRestart">重新获取</x-button>
      </div>
      <span class="modal-layer-close" :style="closeImg" @click="closePopup()"></span>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      closeImg: {
        backgroundImage:
          "url(" + require("@/assets/images/face-img/icon_close.png") + ")",
        backgroundSize: "100%",
      ...
      iconImg: {
        backgroundImage:
          "url(" + require("@/assets/images/face-img/icon_fail.png") + ")",
        backgroundSize: "100%",
        backgroundRepeat: "no-repeat",
        backgroundPosition: "center"
      }
...
.modal-layer {
  ...
  &-close {
    ...
    // background: url(../../../../assets/images/face-img/icon_close.png) 0 0 no-repeat;
  ...
  &-fail {
    &-icon {
      ...
      //   background: url(@/assets/images/face-img/icon_fail.png) 0 0 no-repeat;
      background-size: 100% auto;
    }
